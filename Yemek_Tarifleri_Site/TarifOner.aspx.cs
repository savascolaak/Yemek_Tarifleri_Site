...
public partial class TarifOner : System.Web.UI.Page
{
    ...
    protected void btnTarifiOner_Click(object sender, EventArgs e)
    {
        ...
        komut.Parameters.AddWithValue("@t2", txtMazleme.Text);
        komut.Parameters.AddWithValue("@t3", txtYapilis.Text);
        komut.Parameters.AddWithValue("@t4", txtDosyaYolu.FileName);
